# Hand-off prompt — testing antrop-personas v0.11.5-rc5 in a fresh chat
...
```
Claude personas/
├── antrop-personas-0.11.5-rc5.plugin    # the installable
...
|------|--------------|------------|
| `antrop-personas-0.11.5-rc5.plugin` | Installing the plugin | Stop |
...
v0.11.5-rc5. Everything you need is in the Claude personas folder — that's
your only mount.
...
1. Install antrop-personas-0.11.5-rc5.plugin if it isn't already active.
...
A fresh chat is the difference between "structurally complete" (where v0.11.5-rc5 is) and "actually works in production" (where v1.0.0 needs to be).
