# Hand-off prompt — testing antrop-personas v0.11.3-rc1 in a fresh chat
...
```
Claude personas/
├── antrop-personas-0.11.3-rc1.plugin    # the installable
...
|------|--------------|------------|
| `antrop-personas-0.11.3-rc1.plugin` | Installing the plugin | Stop |
...
v0.11.3-rc1. Everything you need is in the Claude personas folder — that's
your only mount.
...
1. Install antrop-personas-0.11.3-rc1.plugin if it isn't already active.
...
A fresh chat is the difference between "structurally complete" (where v0.11.3-rc1 is) and "actually works in production" (where v1.0.0 needs to be).
