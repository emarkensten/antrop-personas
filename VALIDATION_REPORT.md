# Validation report — antrop-personas v0.11.3-rc1

Date: 2026-05-27 (structural pass); carried forward to v0.11.3-rc1
Run by: Cowork session validation pass

> **Note (0.11.3-rc1):** This report was first written at rc2 and has been carried
...
> Counts in the table reflect the current 0.11.3-rc1 component set.
...
Ship v0.11.3-rc1 as the testable artefact. Bump to v1.0.0 only after step 1 above completes cleanly (no regressions vs. the NV v1 reference deliverables).
